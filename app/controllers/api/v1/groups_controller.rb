class Api::V1::GroupsController < Api::V1::BaseController
  ...
  param :locale, String, :desc => "idioma", :required => false
  param :page, Fixnum, :desc => "Pagina a cargar", :required => false
  param :per_page, :Fixnum, :desc => "numero de registros por pagina", :required => false
